...
```txt
เนื้อหาที่แสดงบนหน้าเว็บต้องเน้นภาษาไทยเป็นหลักเท่านั้น
ใช้ภาษาอังกฤษได้เฉพาะกรณีเป็นรหัสระบบ, enum, route, technical keyword, product/code identifier หรือคำที่ผู้ใช้คุ้นเคยในงานระบบ
