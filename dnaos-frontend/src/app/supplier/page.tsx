...
const LINE_OA_URL = process.env.NEXT_PUBLIC_LINE_SUPPLIER_URL ?? "https://lin.ee/XXXXXXX";
      ...
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            สนใจร่วมเป็นซัพพลายเออร์กับ DNA OS?<br />
            ติดต่อทีมงานผ่าน LINE เพื่อเริ่มกระบวนการสมัคร
          </p>
        </div>
